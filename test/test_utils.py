from rdmapper.utils import mapped_smarts_by_imap, initialize_smarts
...
class TestClass:
    ...
    def test_mapped_smarts_by_imap(self):
        ...
        res = mapped_smarts_by_imap(trg, idx_map)
        assert res == ans
        trg = "[#6:1]1(-[#6:2]2:[#6:3]:[#6:4]:[#6:5]:[#6:6]:[#6:7]:2):[#6:8]:[#6:9]:[#6:10]:[#6:11]:[#6:12]:1>>[#8:13]-[#5:14](-[#6:15]1:[#6:16]:[#6:17]:[#6:18]:[#6:19]:[#6:20]:1)-[#8:21].[#35:22]-[#6:23]1:[#6:24]:[#6:25]:[#6:26]:[#6:27]:[#6:28]:1"
        idx_map = {19:9, 18:10, 17:11, 16:12, 15:1, 26:5, 25:4, 24:3, 23:2, 28:7, 27:6}
        ans = "[#6:1]1(-[#6:2]2:[#6:3]:[#6:4]:[#6:5]:[#6:6]:[#6:7]:2):[#6:8]:[#6:9]:[#6:10]:[#6:11]:[#6:12]:1>>[#8]-[#5](-[#6:1]1:[#6:12]:[#6:11]:[#6:10]:[#6:9]:[#6]:1)-[#8].[#35]-[#6:2]1:[#6:3]:[#6:4]:[#6:5]:[#6:6]:[#6:7]:1"
        res = mapped_smarts_by_imap(trg, idx_map)
        assert res == ans
