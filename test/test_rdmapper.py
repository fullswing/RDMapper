from rdmapper.rdmapper import initialize_smarts, mapped_smarts
...
class TestClass:
    ...
    def test_mapped_smarts(self):
        ...
        ans = "[#8:1]=[#6:2]1-[#6:3]-[#6:4]-[#6:5]-[#6:6]-[#6:7]-1-[#6:8]1-[#6:9]-[#6:10]-[#6:11]-[#6:12]-[#6:13]-1>>[#8:1]=[#6:2]1-[#6:3]-[#6:4]-[#6:5]-[#6:6]-[#6:7]-1.[#6]-[#16](-[#8]-[#6:8]1-[#6:9]-[#6:12]-[#6:11]-[#6:10]-[#6:9]-1)(=[#8])=[#8]"
        res = mapped_smarts(trg, idx_map)
        assert res == ans